// Chat can run on any OpenAI-compatible endpoint (NVIDIA NIM / DeepSeek);
// the photo estimator cannot — it sends images, and DeepSeek-class text models
// have no vision capability. These tests pin that split so a future "just point
// everything at the cheap provider" change fails here instead of silently
// breaking the estimator in production.
